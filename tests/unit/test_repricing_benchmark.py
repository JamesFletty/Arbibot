...
def _case() -> RepricingCase:
    return RepricingCase(
        ...
        current_mid=0.495,
        future_quotes=(
            FutureQuote(offset_ms=50, best_bid=0.4905, best_ask=0.5005),
            FutureQuote(offset_ms=100, best_bid=0.491, best_ask=0.501),
            FutureQuote(offset_ms=250, best_bid=0.492, best_ask=0.502),
            FutureQuote(offset_ms=500, best_bid=0.493, best_ask=0.503),
        ),
    )
